...
const mapName = "StreetMap"; // HERE IT GOES THE NAME OF YOUR MAP
const indexName = "TrackPlaceIndex" // HERE GOES THE NAME OF YOUR PLACE INDEX
const trackerName = "DemoTracker2" // HERE GOES THE NAME OF  YOUR TRACKER
const deviceID = "MyCar" // HERE IT GOES THE NAME OF YOUR DEVICE
    ...
    <div className="container">
      <div className="row">
        <div className="col-10">
          <h1>Location Service D&D Demo</h1>
        </div>
        <div className="col-2">
          <AmplifySignOut />
        </div>
...
function Search(props){
  ...
  const [place, setPlace] = useState('Belfast');
